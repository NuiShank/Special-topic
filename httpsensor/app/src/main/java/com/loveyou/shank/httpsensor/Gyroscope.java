...
// TODO Auto-generated method stub
        ...
        msgy=""+gravity[1];
        msgz=""+gravity[2];
        Thread x = new Thread(new sendPostRunnable(msgx,msgy,msgz));
        x.start();
...
/* 取消註冊SensorEventListener */
    ...
    private String uriAPI = "http://shankmc.no-ip.org:81/sensor/Gyroscope/Gyroscope.php";
    /** 「要更新版面」的訊息代碼 */
    ...
    class sendPostRunnable implements Runnable
    {
        ...
        // 建構子，設定要傳的字串
        public sendPostRunnable(String strTxtx,String strTxty,String strTxtz)
        {
        ...
        public void run()
        {
            String result = sendPostDataToInternet(strTxtx, strTxty, strTxtz);
            mHandler.obtainMessage(REFRESH_DATA, result).sendToTarget();
        }

    }

    private String sendPostDataToInternet(String strTxtx,String strTxty,String strTxtz)
    {
