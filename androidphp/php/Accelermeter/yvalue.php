...
function generateGoogleChart()
{
    ...
    $sqlQuery = "SELECT log_id, Y FROM Accelermeter";
    ...
    $chxl = '1:|' . $graphSequence . '2:|Y-value|3:|次數||4:|次數';//custom axis labels
