...
public class LockService extends Service implements SensorEventListener, OnSystemUiVisibilityChangeListener, OnSharedPreferenceChangeListener{
	...
	private float mAccelCurrent=0,mAccelLast=0;
	...
	public int onStartCommand(Intent intent, int flags, int startId){
		...
		G=Integer.parseInt(sharedPref.getString("gforce", "6"));
	...
	public enum prefValues{
		lockMethod, lockDelay, unlockDelay, gravityRate, upsideDownLockAngle, tableLockAngle, rotateLock, faceDownLock, unlockBeep,G;
	}
